...
enum __attribute__((packed)) Species
{
    ...
    SPECIES_ECHIDNA_1 = 1582,
    SPECIES_ECHIDNA_2 = 1583,
    ...
    SPECIES_FOWLOTUS = 1591,

    SPECIES_TROPILOT = 1592,
    SPECIES_PROPIARY = 1593,
    SPECIES_JETIMBER = 1594,

    SPECIES_LENSECT = 1595,
    SPECIES_GRUBARLO = 1596,
    SPECIES_OBUZZERVE = 1597,

    SPECIES_TERMEET = 1598,
    SPECIES_CLUSTERM = 1599,
    SPECIES_TERMANATE = 1600,

    SPECIES_SIGNOLL = 1601,
    SPECIES_POSSANA = 1602,
    SPECIES_POSSIERRA = 1603,

    SPECIES_CLAMOUR = 1604,
    SPECIES_MUSSCARA = 1605,
    SPECIES_VALVOGUE = 1606,

    SPECIES_GROUND_CONV_1 = 1607,
    SPECIES_GROUND_CONV_2 = 1608,

    SPECIES_THERO_1 = 1609,
    SPECIES_THERO_2 = 1610,
    SPECIES_THERO_3 = 1611,

    SPECIES_CLAYBARA = 1612,
    SPECIES_BRICCAPY = 1613,

    SPECIES_BASILT = 1614,
    SPECIES_HEXTUFF = 1615,
    SPECIES_HEXTATURE = 1616,

    SPECIES_DIMETRO_1 = 1617,
    SPECIES_IGNICYN = 1618,
    SPECIES_DIMETRO_3 = 1619,

    SPECIES_ESCASETE = 1620,
    SPECIES_RECORGOT = 1621,

    SPECIES_TROUBULL = 1622,

    SPECIES_URCHIN_1 = 1623,
    SPECIES_URCHIN_2 = 1624,

    SPECIES_PINNAUGUR = 1625,
    
    SPECIES_SHARKELP = 1626,
    SPECIES_BASKALGAE = 1627,

    SPECIES_SHYFONO = 1628,
    SPECIES_EMSIFONO = 1629,
    SPECIES_SIPHORMIX = 1630,

    SPECIES_DRILLITO = 1631,
    SPECIES_DRILLITOIL = 1632,

    SPECIES_SOLM = 1633,
    SPECIES_CHASOLM = 1634,
    SPECIES_GROTTOLM = 1635,

    SPECIES_ECHORE = 1636,
    SPECIES_RUBITE = 1637,
    SPECIES_VAMPPHIRE = 1638,

    SPECIES_FAIRY_1 = 1639,
    SPECIES_FAIRY_2 = 1640,

    SPECIES_BEETEMOLT = 1641,
    SPECIES_PHANTOMOLT = 1642,

    SPECIES_SKIRMUSH = 1643,
    SPECIES_CORDYSPAR = 1644,

    SPECIES_IGUANADON = 1645,

    SPECIES_FIGHTING = 1646,

    SPECIES_ICIRKRILL = 1647,
    SPECIES_KRILLOWATT = 1648,

    SPECIES_GRAMAIN = 1649,
    SPECIES_TARDEVAIL = 1650,

    SPECIES_TRANSPARENT_FISH_1 = 1651,
    SPECIES_TRANSPARENT_FISH_2 = 1652,
    SPECIES_BARRELEYE = 1653,
    SPECIES_TRANSPARENT_EEL = 1654,

    SPECIES_CANUWAY = 1655,
    SPECIES_STIKSAIL = 1656,
    SPECIES_ARAUKEEL = 1657,

    SPECIES_GHOST_1 = 1658,
    SPECIES_GHOST_2 = 1659,

    SPECIES_LURIDIRT = 1660,
    SPECIES_LURIDWELL = 1661,
    SPECIES_DESOLONG = 1662,

    SPECIES_GNOSEPASS = 1663,
    SPECIES_POCUSPASS = 1664,
    
    SPECIES_FIRE_1 = 1665,

    SPECIES_BEAGLOSS = 1666,

    SPECIES_SPINDA_EVO = 1667,

    SPECIES_FAETO = 1668,
    SPECIES_SILFILM = 1669,
    SPECIES_GALLAERY = 1670,

    SPECIES_FLYING_1 = 1671,
    SPECIES_FLYING_2 = 1672,
    SPECIES_FLYING_3 = 1673,

    SPECIES_FIGHTING_1 = 1674,
    SPECIES_FIGHTING_2 = 1675,
    SPECIES_FIGHTING_3 = 1676,

    SPECIES_GIZMIT = 1677,
    SPECIES_CRAWIDGET = 1678,
    
    SPECIES_SOLO_ELECTRIC_1 = 1679,
    SPECIES_SOLO_ELECTRIC_2 = 1680,

    SPECIES_OHMEOW = 1681,
    SPECIES_AMPURR = 1682,
    SPECIES_COMPROAR = 1683,

    SPECIES_SOLAR_WIND_1 = 1684,
    SPECIES_SOLAR_WIND_2 = 1685,

    SPECIES_HEALER = 1686,

    SPECIES_VEILDUCK = 1687,

    SPECIES_SMOULDRA = 1688,

    SPECIES_FROSTYLO = 1689,
    SPECIES_FRACTYLO = 1690,

    SPECIES_TOTULLY = 1691,
    SPECIES_MONSTOXIN = 1692,

    SPECIES_GEKOBOLD = 1693,
    SPECIES_URDROWSY = 1694,
    SPECIES_DRACOZY = 1695,

    SPECIES_MOSSCRUE = 1696,
    SPECIES_MOSSTRATA = 1697,
    SPECIES_MOSSTROMA = 1698,

    SPECIES_TINYMPH = 1699,
    SPECIES_PHASMESH = 1700,
    SPECIES_PHASMETAL = 1701,

    SPECIES_STRIGILENT = 1702,
    SPECIES_SOMNILUS = 1703,
    SPECIES_CHIRURGE = 1704,
    ...
    SPECIES_BYGONE_1 = 1710,
    SPECIES_BYGONE_2 = 1711,
    SPECIES_BYGONE_3 = 1712,

    SPECIES_FORMANDALA = 1713,
    
    SPECIES_SOLO_LEGEND_1 = 1714,

    SPECIES_SOLO_LEGEND_2 = 1715,

    SPECIES_PHASMETAL_M = 1716,

    SPECIES_BEAGLOSS_1 = 1717,
    SPECIES_BEAGLOSS_2 = 1718,

    SPECIES_FORMANDALA_B = 1719,

    SPECIES_BUILDER_B = 1720,
    SPECIES_GATHERER_B = 1721,
    SPECIES_HARVESTER_B = 1722,
    SPECIES_AROMATISSE_B = 1723,
    SPECIES_PHILOSOPHER_B = 1724,
    SPECIES_DESOLONG_B = 1725,
    SPECIES_RIBOMBEE_B = 1726,
    SPECIES_NOMAD_B = 1727,
    SPECIES_KEEPER_B = 1728,
    SPECIES_SCRIBE_B = 1729,
    SPECIES_WARRIOR_B = 1730,
    SPECIES_IDK_B = 1731,
    SPECIES_WEAVILE_B = 1732,
