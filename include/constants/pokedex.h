...
enum NationalDexOrder
{
    ...
    NATIONAL_DEX_ECHIDNA_1,
    NATIONAL_DEX_ECHIDNA_2,
    ...
    NATIONAL_DEX_LENSECT,
    NATIONAL_DEX_GRUBARLO,
    NATIONAL_DEX_OBUZZERVE,
    ...
    NATIONAL_DEX_GROUND_CONV_1,
    NATIONAL_DEX_GROUND_CONV_2,
    NATIONAL_DEX_THERO_1,
    NATIONAL_DEX_THERO_2,
    NATIONAL_DEX_THERO_3,
    NATIONAL_DEX_CLAYBARA,
    NATIONAL_DEX_BRICCAPY,
    NATIONAL_DEX_BASILT,
    NATIONAL_DEX_HEXTUFF,
    NATIONAL_DEX_HEXTATURE,
    NATIONAL_DEX_DIMETRO_1,
    NATIONAL_DEX_IGNICYN,
    NATIONAL_DEX_DIMETRO_3,
    NATIONAL_DEX_ESCASETE,
    NATIONAL_DEX_RECORGOT,
    NATIONAL_DEX_TROUBULL,
    NATIONAL_DEX_URCHIN_1,
    NATIONAL_DEX_URCHIN_2,
    ...
    NATIONAL_DEX_ECHORE,
    NATIONAL_DEX_RUBITE,
    NATIONAL_DEX_VAMPPHIRE,
    NATIONAL_DEX_FAIRY_1,
    NATIONAL_DEX_FAIRY_2,
    NATIONAL_DEX_BEETEMOLT,
    NATIONAL_DEX_PHANTOMOLT,
    NATIONAL_DEX_SKIRMUSH,
    NATIONAL_DEX_CORDYSPAR,
    NATIONAL_DEX_IGUANADON,
    NATIONAL_DEX_FIGHTING,
    NATIONAL_DEX_ICIRKRILL,
    NATIONAL_DEX_KRILLOWATT,
    NATIONAL_DEX_GRAMAIN,
    NATIONAL_DEX_TARDEVAIL,
    NATIONAL_DEX_TRANSPARENT_FISH_1,
    NATIONAL_DEX_TRANSPARENT_FISH_2,
    NATIONAL_DEX_BARRELEYE,
    NATIONAL_DEX_TRANSPARENT_EEL,
    NATIONAL_DEX_CANUWAY,
    NATIONAL_DEX_STIKSAIL,
    NATIONAL_DEX_ARAUKEEL,
    NATIONAL_DEX_GHOST_1,
    NATIONAL_DEX_GHOST_2,
    ...
    NATIONAL_DEX_SPINDA_EVO,
    NATIONAL_DEX_FAETO,
    NATIONAL_DEX_SILFILM,
    NATIONAL_DEX_GALLAERY,
    NATIONAL_DEX_FLYING_1,
    NATIONAL_DEX_FLYING_2,
    NATIONAL_DEX_FLYING_3,
    NATIONAL_DEX_FIGHTING_1,
    NATIONAL_DEX_FIGHTING_2,
    NATIONAL_DEX_FIGHTING_3,
    NATIONAL_DEX_GIZMIT,
    NATIONAL_DEX_CRAWIDGET,
    NATIONAL_DEX_SOLO_ELECTRIC_1,
    NATIONAL_DEX_SOLO_ELECTRIC_2,
    NATIONAL_DEX_OHMEOW,
    NATIONAL_DEX_AMPURR,
    NATIONAL_DEX_COMPROAR,
    NATIONAL_DEX_SOLAR_WIND_1,
    NATIONAL_DEX_SOLAR_WIND_2,
    NATIONAL_DEX_HEALER,
    ...
    NATIONAL_DEX_DUO_1,
    NATIONAL_DEX_DUO_2,
    NATIONAL_DEX_BYGONE_1,
    NATIONAL_DEX_BYGONE_2,
    NATIONAL_DEX_BYGONE_3,
    NATIONAL_DEX_FORMANDALA,
    NATIONAL_DEX_SOLO_LEGEND_1,
    NATIONAL_DEX_SOLO_LEGEND_2,
};

#define JOHTO_DEX_COUNT     NATIONAL_DEX_CELEBI

#if P_GEN_9_POKEMON == TRUE
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_SOLO_LEGEND_2
...
#define FOREACH_SPECIES_IN_HOENN_DEX_ORDER(F) \
    ...
    F(GRAMAIN)\
    F(TARDEVAIL)\
    F(TRANSPARENT_FISH_1)\
    F(TRANSPARENT_FISH_2)\
    F(BARRELEYE)\
    F(TRANSPARENT_EEL)\
    F(SEEL)\
    F(DEWGONG)\
...
#define HOENN_DEX_COUNT (HOENN_DEX_SOLO_LEGEND_2 + 1)
